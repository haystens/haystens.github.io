...
$(document).ready(function () {
    ...
    ////////////////// CHANGE UA # HERE /////////////////////
    ga('create', 'UA-109308540-2', 'auto', 'lt');

    //Get User Information
    sUserId = ENV["current_user_id"];
    ga('lt.set', 'dimension1', sUserId);
    ...
    ga('lt.set', 'dimension3', sUserRole);
    ...
    if (sCourseId) {
        ...
        $.get('/api/v1/courses/' + sCourseId, function (_course) {
            ...
            // ...do stuff...
            ga('lt.set', 'dimension4', sCourseId);
            ga('lt.set', 'dimension5', sCourseName);
            ga('lt.set', 'dimension6', parent_account);
            ga('lt.send', 'pageview');
        });
    } else {
        ga('lt.send', 'pageview');
  ...
  if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){
    ...
    switch(university) {
      ...
      case 'iese':
        ...
        inputPass.placeholder = 'ContraseÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±a';
        document.querySelectorAll('label[for=pseudonym_session_password]')[0].textContent = "ContraseÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±a";
        document.querySelectorAll('a[id=login_forgot_password]')[0].textContent = "ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¿OlvidÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â© mi contraseÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±a?";
        document.querySelectorAll('p[id=forgot_password_instructions]')[0].textContent = "Ingrese su correo electrÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â³nico y le enviaremos un enlace para cambiar su contraseÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â±a.";
        document.querySelectorAll('a[class=ic-Login__actions--left ic-Login__link login_link]')[0].textContent = "Regresar a la pÃƒÆ’Ã†â€™Ãƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚Â¡gina de inicio";
        break;
...
$(document).ready(function () {
  ...
  var emailMatch = queryParams.match(emailRegex);

  if (emailMatch !== null) {
    var emailInput = document.querySelector("input[name='pseudonym_session[unique_id]']");
    emailInput.value = emailMatch[1];
  }
});

/* Atomic Jolt Script Start */
